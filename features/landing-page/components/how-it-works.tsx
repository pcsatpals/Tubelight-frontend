        ...
        >
            ...
            >
                {howItWorksData.map((item, index) => (
                    <div key={index} className='flex xl:flex-row flex-col gap-10 backdrop-blur-xl justify-between sticky top-[100px] glass-card p-5 sm:p-10 rounded-3xl  gap-2 min-h-fit md:max-h-[700px] w-full bg-black/80'>
