    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-175">
                <DialogHeader>
                    <DialogTitle>Add a New Caurse</DialogTitle>
                    <DialogDescription>
                        Create a new Caurse
                    </DialogDescription>
                </DialogHeader>
                <FieldGroup>
                    <Field>
                        ...
                        <Input
                            id="name"
                            name="name"
                            placeholder="Enter Caurse Name here"
                            onChange={(e) => {
                    ...
                    <Field>
                        ...
                        <Textarea
                            id="description"
                            name="description"
                            placeholder="Enter Caurse Description here"
                            className="min-h-30"
                            onChange={(e) => {
                ...
                <DialogFooter>
                    ...
                    <Button type="submit" onClick={() => {
                        if (!formData.name) {
                            setError((prev) => ({ ...prev, name: "Caurse Name is required" }))
                        }
                        if (!formData.description) {
                            setError((prev) => ({ ...prev, description: "Caurse description is required" }))
                        }
