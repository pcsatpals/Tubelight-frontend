...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  // WebGL support check without setState
  ...
  const parseColor = useCallback((hex: string): THREE.Vector3 => {
  ...
  }, [topColor, bottomColor, intensity, rotationSpeed, interactive, glowAmount, pillarWidth, pillarHeight, noiseIntensity, pillarRotation, webGLSupported, parseColor, vertexShader, fragmentShader]);
